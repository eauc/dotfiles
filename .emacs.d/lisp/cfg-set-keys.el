...
(global-set-key (kbd "<f5>")    '(lambda () (interactive) (bookmark-set "SAVED")))
(global-set-key (kbd "<C-f5>")      '(lambda () (interactive) (bookmark-jump "SAVED")))
(global-set-key (kbd "<S-f5>")  'bookmark-set)
(global-set-key (kbd "<C-S-f5>")    'bookmark-jump)
