...
** Moves
   ...
   (use-package cool-moves
     ...
     :bind (("<C-S-down>" . 'cool-moves/paragraph-forward)
            ("<C-S-up>" . 'cool-moves/paragraph-backward)
            ("C-S-z" . 'cool-moves/line-forward)
            ("C-S-w" . 'cool-moves/line-backward)
            ("C-S-s" . 'cool-moves/word-forward)
            ("C-S-a" . 'cool-moves/word-backwards)))
   #+END_SRC
